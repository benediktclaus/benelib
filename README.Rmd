...
# benelib
The `benelib` contains some helper functions for commonly executed tasks, and thus a convenient workflow in R.
...
Those can be used via `scale_color_*` oder `scale_fill_*` and the respective name of the color scheme's institution. Those can be mapped to continuous variables as well.
